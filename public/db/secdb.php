...
if (!$link)
{ echo "MySQL 접속 에러: "; echo mysqli_connect_error(); exit(); }
						...
						<nav id="nav">
							...
							<ul>		
								<!-- 사이드바 부분
									...
									각 조를 구별하기 위해 사용
									banner - 초기 화면 (슬라이더)
									Secretary - 스마트 비서, farm - 스마트 팜, home - 스마트 홈, mar - 스마트 마켓, 
									sch - 스마트 스쿨, com - 스마트 컴퍼니, plot - 스마트 주차장, pft - 무인 체력장
								-->	
								<li><a href="#sec" id="park-link" class="skel-layers-ignoreHref"><span class="icon fa-tree">Smart Secretary</span></a></li>
								...
								<li><a href="pftdb.php" id="pft-link" class="skel-layers-ignoreHref"><span class="icon fa-heartbeat">Unnamed PFT</span></a></li>
							</ul>
						</nav>
				</div>
			</div>
...
<a href="down.php">파일 다운받기</a>
					...
					<a href="index.html#sec">
						<img src="image/secretary_off.png"
						onmouseover='this.src="image/secretary_ex.png"'
						onmouseout='this.src="image/secretary_off.png"'/>
