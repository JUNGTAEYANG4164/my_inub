					...
					<!-- 네비게이션 링크로 구성된 섹션임 -->
						<nav id="nav">
							...
							<ul>		
								...
								<li><a href="#mar" id="mar-link" class="skel-layers-ignoreHref"><span class="icon fa-shopping-cart">Smart Market</span></a></li>
...
<a href="down.php">파일 다운받기</a>
					...
					<div>
					<a href="index.html#mar">
						<img src="image/mar_off.png"
						onmouseover='this.src="image/mar_ex.png"'
						onmouseout='this.src="image/mar_off.png"'/>
