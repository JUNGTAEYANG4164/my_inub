					...
					<!-- 네비게이션 링크로 구성된 섹션임 -->
						<nav id="nav">
							...
							<ul>		
								...
								<li><a href="#sch" id="sch-link" class="skel-layers-ignoreHref"><span class="icon fa-graduation-cap">Smart School</span></a></li>
		...
		<!-- Main -->
			<div id="main">
					...
					<section id="plot">
						...
						<p>
						class : 학년-반을 기록</br>
						floor : 교실이 위치한 층을 기록</br>
						stuID : 학생 고유 ID 값</br>					
						</p>
					<a href="down.php">파일 다운받기</a>
					<div>
					<a href="index.html#sch">
						<img src="image/sch_off.png"
						onmouseover='this.src="image/sch_ex.png"'
						onmouseout='this.src="image/sch_off.png"'/>
