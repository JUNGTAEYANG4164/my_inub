					...
					<!-- 네비게이션 링크로 구성된 섹션임 -->
						<nav id="nav">
							...
							<ul>		
								...
								<li><a href="#plot" id="plot-link" class="skel-layers-ignoreHref"><span class="icon fa-product-hunt">Smart Parking lot</span></a></li>
					...
					<section id="plot">
						<div class="container">
							<header>
								<!-- 조명 및 조원-->
								<h2>
									<strong>Smart Parking lot</strong>
								</h2>
							</header>
						...
						<!-- 작품 소개 및 설명-->
						<p>
						logNumber : 로그 기록된 순서 체크</br>
						userID : 고객 ID 값</br>
						logText : 로그 기록</br>					
						</p>
					<a href="down.php">파일 다운받기</a>
					<div>
					<a href="index.html#plot">
						<img src="image/plot_off.png"
						onmouseover='this.src="image/plot_ex.png"'
						onmouseout='this.src="image/plot_off.png"'/>
