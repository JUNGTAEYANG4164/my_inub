					...
					<!-- 네비게이션 링크로 구성된 섹션임 -->
						<nav id="nav">
							...
							<ul>		
								...
								<li><a href="#home" id="home-link" class="skel-layers-ignoreHref"><span class="icon fa-home">Smart Home</span></a></li>
		...
		<!-- Main -->
			<div id="main">
					...
					<section id="home">
						...
						<!-- 작품 소개 및 설명-->
						<p>
						door : 현관문이 열려있는지의 여부</br>
						window : 창문이 열려있는지의 여부</br>
						gas : 가스 밸브가 잠겨있는지의 여부</br>					
						</p>
					<a href="down.php">파일 다운받기</a>
					<div>
					<a href="index.html#home">
						<img src="image/home_off.png"
						onmouseover='this.src="image/home_ex.png"'
						onmouseout='this.src="image/home_off.png"'/>
