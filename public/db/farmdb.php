					...
					<!-- 네비게이션 링크로 구성된 섹션임 -->
						<nav id="nav">
							...
							<ul>		
								...
								<li><a href="#farm" id="farm-link" class="skel-layers-ignoreHref"><span class="icon fa-pagelines">Smart Farm</span></a></li>
		...
		<!-- Main -->
			<div id="main">
					...
					<section id="com">
						...
						ID : 작물 ID 값</br>
						Temperture : 온실 온도</br>
						Water : 작물에 공급되는 물의 양</br>					
						</p>
					<a href="down.php">파일 다운받기</a>
					<div>
					<a href="index.html#farm">
						<img src="image/farm_off.png"
						onmouseover='this.src="image/farm_ex.png"'
						onmouseout='this.src="image/farm_off.png"'/>
