					...
					<!-- 네비게이션 링크로 구성된 섹션임 -->
						<nav id="nav">
							...
							<ul>		
								...
								<li><a href="#com" id="com-link" class="skel-layers-ignoreHref"><span class="icon fa-building">Smart Company</span></a></li>
...
<a href="down.php">파일 다운받기</a>
					...
					<div>
					<a href="index.html#com">
						<img src="image/com_off.png"
						onmouseover='this.src="image/com_ex.png"'
						onmouseout='this.src="image/com_off.png"'/>
